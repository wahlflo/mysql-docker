...
MYSQL_ROUTER_PACKAGE_URL_ARG="ARG MYSQL_ROUTER_PACKAGE_URL=\$REPO/yum/mysql-tools-preview/el/7/x86_64/mysql-router-$MYSQL_ROUTER_RPM_VERSION.el7.x86_64.rpm"
